...
namespace Projeto_TCC
{
    ...
    public partial class Cadastro : Form
    {
        ...
        private void btnConectar_Click(object sender, EventArgs e)
        {
                ...
                string INS_CAD = "insert into medico values (default,@nome,@data_nasc,@telefone,@cpf,@rg,@rua,@numero_da_casa,@cidade,@bairro,@cep,@complemento,@uf,@email,@senha,@dados_adicionais,@CRM,@especialidade) ";
                ...
                comando3.Parameters.AddWithValue("@CRM", crm.Text);
                comando3.Parameters.AddWithValue("@especialidade", especialidade.Text);
